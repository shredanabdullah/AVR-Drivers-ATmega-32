...
#define LCD_ENTRY_MODE_SET            0x06/*shift cursor from left to right on read/write*/
#define LCD_DISPLAY_OFF               0x08/*turn display off*/
#define LCD_DISPLAY_ON_CURSOR_ON      0x0E/*display on, cursor off, don't blink character*/
#define LCD_FUNCTION_RESET            0x30/*reset the lcd*/
#define LCD_FUNCTION_SET_8BIT         0x38/*8-bit data, 2 line display, 5*7 font*/
#define LCD_SET_CURSOR_POSITION       0x80/*set cursor position*/
#define LCD_DISPLAY_ON_CURSOR_BLINK   0x0F/*display on, cursor blinking*/
